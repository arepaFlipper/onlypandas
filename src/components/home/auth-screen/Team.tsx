...
const teamList: TeamProps[] = [
  {
    ...
    description: "Dr. Carter is our resident veterinarian, dedicated to maintaining the health of our pandas.",
  },
  {
    imageUrl: "https://i.pravatar.cc/150?img=35",
    name: "Sarah Thompson",
    position: "Farm Manager",
    description: "Sarah ensures the smooth operation of the farm and ensuring the well-being of all our pandas. ",
  },
  {
    imageUrl: "https://i.pravatar.cc/150?img=60",
    name: "James Wilson",
    position: "Head Trainer",
    description: "James is our expert in pandas training and riding instruction with over 15 years of experience",
  },
  {
    imageUrl: "https://i.pravatar.cc/150?img=17",
    name: "Michael Ramirez",
    position: "Groom and Stable Hand",
    description: "Michael is responsible for the daily care of our pandas, including feeding and grooming. ",
  },
];
  ...
  return (
    <section className='container py-24 sm:py-32'>
      ...
      <p className='mt-4 mb-10 text-md md:text-xl text-muted-foreground text-center'>
        Meet the team that makes our farm a special place for pandas and riders alike.
      </p>
        ...
        {teamList.map(({ description, imageUrl, name, position }) => (
          <Card key={name} className='bg-muted/50 relative mt-7 flex flex-col justify-center items-center'>
            <CardHeader className='my-8 flex justify-center items-center pb-2'>
              <Image src={imageUrl} alt='Team member' width={96} height={96}
