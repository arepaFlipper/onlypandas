...
const reviews = [
  {
    name: "Jack",
    username: "@jack",
    body: "The Panda care tips are incredibly helpful. Love this site!",
    img: "https://avatar.vercel.sh/jack",
  },
  {
    name: "Jill",
    username: "@jill",
    body: "Fantastic insights on Panda training. Highly recommend!",
    img: "https://avatar.vercel.sh/jill",
  },
  {
    name: "John",
    username: "@john",
    body: "Great community for Panda lovers. Very informative!",
  ...
  },
  {
    name: "James",
    username: "@james",
    body: "Panda health tips are spot on. Very useful website!",
  ...
  return (
    <div className='mt-12'>
      ...
      <p className='mt-4 mb-10 text-md md:text-xl text-muted-foreground text-center'>
        Hear from our happy customers and see why they love our content.
      </p>
