      ...
      <Container style={container}>
        ...
        <Section style={message}>
          <Img
            ...
            style={{ margin: "auto" }}
          />
          <Heading style={global.heading}>It&#39s On Its Way.</Heading>
        ...
        <Section style={paddingY}>
          <Row>
            <Text style={{ ...footer.text, paddingTop: 30, paddingBottom: 30 }}>
              Please contact us if you have any questions. (If you reply to this email, we won&#39t be able
              to see it.)
            </Text>
          </Row>
          <Row>
            <Text style={footer.text}>
              © {new Date().getFullYear()} OnlyPandas, Inc. All Rights Reserved.
            </Text>
          </Row>
        </Section>
      </Container>
